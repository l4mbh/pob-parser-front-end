...
const Notes = () => {
  ...
  if (notes) {
    ...
    return (
      <div className="bg-content1 dark:bg-backgroundPrimary h-auto rounded-md mt-10 p-2">
      <div className="divider text-light dark:text-dark font-extrabold text-2xl my-2">NOTES</div>
